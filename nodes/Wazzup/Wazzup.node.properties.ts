...
export const wazzupNodeProperties: INodeProperties[] = [
	...
	},
	{
		...
		default: '[]',
		description: 'JSON array with one or more contact objects to create',
	},
	{
	...
	},
	{
		...
		default: '[]',
		description: 'JSON array with one or more deal objects to create',
	},
	{
		displayName: 'Deal ID',
		name: 'dealId',
	...
	},
	{
		...
		displayOptions: { show: { resource: ['deal'], operation: ['update'] } },
		default: '{}',
		description: 'JSON object with deal data to update',
	},
	{
